    ...
    /* == MAIN == */
      ...
      initKeepSession: function() {
        ...
        window.setInterval(function() {
          ...
          if($("#npuStatus").size() == 0) {
            $("#upTraining_lblRemainingTime").html('<span id="npuStatus" style="font-weight: normal"><a href="https://github.com/davimatyi/npu" target="_blank">Neptun PowerUp!</a> v' + GM.info.script.version + '</span>');
          }
        }, 1000);
      },
        ...
        window.setInterval(function() {
          ...
          if(innerTable.size() > 0 && innerTable.attr("data-inner-choices-displayed") != "1") {
            ...
            if(subjectText != null) {
              ...
              var subjectCode = npu.parseSubjectCode(part);
              if(subjectCode) {
                var choices = courses[subjectCode.trim().toUpperCase()];
